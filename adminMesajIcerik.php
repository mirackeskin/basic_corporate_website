        ...
        <div class="container">
            <div class="row ">
                ...
                <?php 
                    ...
                    $verisor=$db->prepare("SELECT * FROM iletisim_tablosu WHERE iletisim_id=$iletisim_id");
                    $verisor->execute();
                    $vericek=$verisor->fetch(PDO::FETCH_ASSOC);
                ?>
                    <div class="form-group">
                        <label ><b>Mesaj İçeriği<b></label><br>
                        <textarea name="" id="" cols="35" rows="15" readonly><?php echo $vericek['iletisim_mesaj']; ?></textarea>
                    </div>
                    <a href="adminMesajKutusu.php" class="btn btn-primary">Geri Dön!</a>                    
                </div>
                <div class="col-md-3"></div>
            </div>
        </div>
